...
exports.seed = function(knex, Promise) {
  ...
  return knex('markers').del()
    ...
    .then(function () {
      ...
      return Promise.all([
        knex('markers').insert({map_id: 1, longitude: 43.6, latitude: -79.3, title: "mymarker", description: 'stuff', image_url: 'asd'}),
        knex('markers').insert({map_id: 1, longitude: -79.3, latitude: 43.6, title: "mymarker", description: 'stuff', image_url: 'asd'})
      ]);
    });
};
